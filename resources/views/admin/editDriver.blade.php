                ...
                <div class="panel-body ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" name="name" id="name" value="{{ $id->name }}" class="form-control" placeholder="Name">
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" name="family" id="family" value="{{ $id->family }}" class="form-control" placeholder="Family">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="email" name="email" value="{{ $id->email }}" id="email" class="form-control" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" name="phonenumber" value="{{ $id->phonenumber }}" id="phonenumber" class="form-control" placeholder="Phone Number" maxlength="11" minlenght="10">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" name="hourlywage" value="{{ $driversD->hourlywage }}" id="hourlywage" class="form-control" placeholder="Cost per Hour" maxlength="11">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $driversD->plate }}" name="plate" id="plate" class="form-control" placeholder="License Plate" maxlength="11">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                <input type="time" name="starttime" value="{{ $driversD->begintime }}"
                                       id="starttime" class="form-control" maxlength="11">
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                <input type="time" name="endtime" value="{{ $driversD->endtime }}"
                                       id="endtime" class="form-control" maxlength="11">
                            </div>
                        </div>
                    </div>
